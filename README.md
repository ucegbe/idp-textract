...
<img src="images/doc analysis.png" width="600"/>
...
- **Document Summarization:** Automatically generate concise summaries of medical documents, enabling agents to quickly grasp essential information.
...
- **Data Extraction:** Extract structured data from medical forms, invoices, and reports, reducing manual data entry and improving accuracy.
...
<img src="images/med-sum.png" width="800"/>

1. Upload PDF or image files containing medical documents.
2. Select the desired AI model and processing options.
3. Generate document summaries by clicking the "Summarize" button.
4. Use the chat interface to ask questions and retrieve answers from the uploaded documents.
5. Extract data from the documents in JSON foormat using the "Extract" button.
6. Monitor token usage and estimated costs in the sidebar.
